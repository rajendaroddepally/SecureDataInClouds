    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          String   report = "dfdsf";
            ...
            int i = st.executeUpdate("insert into userregi (username,password,emailid,gender,date,phone,location)values('"+username+"','"+password+"','"+mailid+"','"+gender+"','"+date+"','"+phone+"','"+location+"')"); 
            
             if(i!=0){

                 
                 response.sendRedirect("registraction.jsp?Msg=Submitted");
