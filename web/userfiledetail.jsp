...
<div class="banner-wrapper">
  <div class="banner">
    <div class="banner-image"> 
       <center><h1 style="font-size: 40px;color:#2F4F4F;font-family:Algerian;">FILE DETAILS</h1></center>
         <div>
                   
                  <div class="CSSTableGenerator" style="width:900px;height: 300px;overflow: auto">
             <table>
                 <tr><td>CAPTION</td><td>DESCRIP</td><td>FILENAME</td><td>FILE_OWNER</td><td>FILE_REQUEST</td></tr>
    ...
    Statement st = con.createStatement();
         ResultSet rs = st.executeQuery("select * from fileupload where prosystatus = '"+status+"'   ");
                       while (rs.next()) {
                           ...
                           String fnames =rs.getString("fnames");
        ...
        <tr>
            ...
            <td style="color:#B22222"><%=fname%></td>
             <td style="color:#B22222"><%=fileid%></td>
             <td style="color:#B22222"><%=fnames%></td>
             <td style="color:#B22222"><%=onames%></td>
             <td style="color:red"><a href="ufilerequst2.jsp?<%=rs.getInt("id")%>" style="margin-top:500px">RSEND</a> </td></tr>
