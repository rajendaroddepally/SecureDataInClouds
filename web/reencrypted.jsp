...
<div class="banner-wrapper">
  <div class="banner">
    <div class="banner-image"> 
       <center><h1 style="font-size: 40px;color:#2F4F4F;font-family:Algerian;">REENCRYPTED FILES</h1></center>
         <div>
                   
                  <div class="CSSTableGenerator" style="width:900px;height: 300px;overflow: auto">
             <table>
                 <tr><td>ID</td><td>CAPTION</td><td>DESCRIP</td><td>FILENAME</td> <td>FILE_OWNER</td><td>STATUS</td></tr>
    ...
    Statement st = con.createStatement();
         ResultSet rs = st.executeQuery("select * from fileupload where prosystatus = 'encrypted' ");
                       while (rs.next()) {
...
<tr>
            ...
            <td  style="color:#B22222"><%=status%></td></tr>
