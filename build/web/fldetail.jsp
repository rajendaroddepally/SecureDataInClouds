  ...
  <div class="banner">
    <div class="banner-image"> 
       <center><h1 style="font-size: 40px;color:#2F4F4F;font-family:Algerian;">FILE DETAILS</h1></center>
         <div>
             ...
             <table>
                 <tr><td>ID</td><td>caption</td><td>FILEID</td><td>FILENAME</td><td>FILE_OWNER</td><td>MASTER_KEY</td><td>PRIVATE_KEY</td></tr>
    ...
    Statement st = con.createStatement();
        ...
        <tr>
            ...
            <td  style="color:#B22222"><%=masterky%></td>
            <td  style="color:#B22222"><%=privatkey%></td>
