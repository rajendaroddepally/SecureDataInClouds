            ...
            <div class="banner">
                <div class="banner-image"> 
                    ...
                    <div  style="float:left">
                        <form action="keyverifica3.jsp" method="post" >
                            <%
         ...
         ResultSet rs = st.executeQuery("select * from fileupload  where id='"+s+"'  ");
                       while (rs.next()) {
                           ...
                           String proxyreenc=rs.getString("Ownername");
                            ...
                            String prreencrypt = aes.decrypt(proxyreenc);
        ...
        %>
                            <table>
                                ...
                                <tr><td style="font-size: 30px;color:#DB7093;font-family:Baskerville Old Face;height:60px">DESCRIPTION</td><td><input type="text" class="css-input" value="<%=desp%>"></input></td></tr>
                                 <tr><td style="font-size: 30px;color:#DB7093;font-family:Baskerville Old Face;height:60px">DECRYPT</td><td><textarea style="widht:230px;height:130px;"class="css-input" ><%=prreencrypt%> </textarea></td></tr>
                                  <tr><td style="font-size: 30px;color:#DB7093;font-family:Baskerville Old Face;height:60px">Private_key</td><td><input  class="css-input" name="pkey"> </input></td></tr>
