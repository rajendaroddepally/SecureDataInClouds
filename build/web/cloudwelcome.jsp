  ...
  <div class="header">
    ...
    <div class="menu">
      <ul>
        ...
        <li><a href="cloudrecivereq.jsp">RECIVEREQUEST</a></li>
...
<div class="banner-wrapper">
  <div class="banner">
    <div class="banner-image"> 
       <center><h1 style="font-size: 40px;color:#2F4F4F;font-family:Algerian;height:60px">CLOUD</h1></center>
